...
namespace CineTPIProgII.Repositories.Utils
{
    public class DataHelper
    {
        ...
        {
            //Primer paso
            _connection = new SqlConnection(@"Data Source=.\\SQLEXPRESS;Initial Catalog=CineProg1;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
        }
